...
import { TutorialGroupState } from '.././schemas';
import type { PagedTutorialGroupListSchema, TutorialGroupDetailSchema } from '.././schemas';

export const getMainAppsTutorialsRoutersTutorialGroupRouterGetTutorialGroupsResponseMock = (
    overrideResponse: Partial<PagedTutorialGroupListSchema> = {},
): PagedTutorialGroupListSchema => ({
    items: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
        id: faker.string.uuid(),
        state: faker.helpers.arrayElement(Object.values(TutorialGroupState)),
        tutorial_count: faker.number.int({ min: undefined, max: undefined }),
...
export const getMainAppsTutorialsRoutersTutorialGroupRouterCreateTutorialGroupResponseMock = (
    overrideResponse: Partial<TutorialGroupDetailSchema> = {},
...
export const getMainAppsTutorialsRoutersTutorialGroupRouterGetTutorialGroupResponseMock = (
    overrideResponse: Partial<TutorialGroupDetailSchema> = {},
): TutorialGroupDetailSchema => ({
    id: faker.string.uuid(),
    state: faker.helpers.arrayElement(Object.values(TutorialGroupState)),
...
export const getMainAppsTutorialsRoutersTutorialGroupRouterGetTutorialGroupsMockHandler = (
    overrideResponse?:
        | PagedTutorialGroupListSchema
        | ((
              info: Parameters<Parameters<typeof http.get>[1]>[0],
          ) => Promise<PagedTutorialGroupListSchema> | PagedTutorialGroupListSchema),
) => {
    return http.get('*/api/tutorial-groups/', async (info) => {
        await delay(1000);
...
export const getMainAppsTutorialsRoutersTutorialGroupRouterCreateTutorialGroupMockHandler = (
    overrideResponse?:
        | TutorialGroupDetailSchema
        | ((
              info: Parameters<Parameters<typeof http.post>[1]>[0],
          ) => Promise<TutorialGroupDetailSchema> | TutorialGroupDetailSchema),
) => {
    return http.post('*/api/tutorial-groups/', async (info) => {
        await delay(1000);
...
export const getMainAppsTutorialsRoutersTutorialGroupRouterGetTutorialGroupMockHandler = (
    overrideResponse?:
        | TutorialGroupDetailSchema
        | ((
              info: Parameters<Parameters<typeof http.get>[1]>[0],
    ...
    return http.get('*/api/tutorial-groups/:tutorialGroupId/', async (info) => {
        await delay(1000);
...
export const getMainAppsTutorialsRoutersTutorialGroupRouterUpdateTutorialGroupMockHandler = (
    overrideResponse?:
        | TutorialGroupDetailSchema
        | ((
    ...
    return http.put('*/api/tutorial-groups/:tutorialGroupId/', async (info) => {
        await delay(1000);
...
export const getMainAppsTutorialsRoutersTutorialGroupRouterDeleteTutorialGroupMockHandler = (
    overrideResponse?: void | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<void> | void),
) => {
    return http.delete('*/api/tutorial-groups/:tutorialGroupId/', async (info) => {
        await delay(1000);
